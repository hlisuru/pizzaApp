...
public class Pizza_List_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pizza__list_);

        request_url = "http://172.19.64.217:8080/demo/all";
    ...
    public void Request(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, request_url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                pAdapter = new CustomListAdapter(Pizza_List_Activity.this, pizza);
